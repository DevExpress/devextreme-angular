...
### Bug Fixes
- DevExtreme widgets should render templates within Angular Zone[#883](https://github.com/DevExpress/devextreme-angular/pull/883)
...
### Features
- Update `devextreme` version to 18.1.5
